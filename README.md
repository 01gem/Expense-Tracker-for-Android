...
| 📅 **Calendar** | Custom fintech-themed grid with **gold dot indicators** for days with expenses. Features a sequential Year → Month jump selector and instant "Reset to Today" action. |
